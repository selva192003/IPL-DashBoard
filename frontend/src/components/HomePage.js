...
import PointsTablePreview from './PointsTablePreview';
    ...
    return (
        <div className="HomePage min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950 text-white font-sans overflow-hidden">
            ...
            <div className="relative z-10 w-full">
                {/* Redesigned Hero Section (premium IPL styling) */}
                <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
                  <HeroSection onViewTeams={() => { const el = document.getElementById('teams-section'); el?.scrollIntoView({ behavior: 'smooth' }); }}
                               onViewStats={() => { const el = document.getElementById('stats-section'); el?.scrollIntoView({ behavior: 'smooth' }); }} />
                </div>

                {/* Quick premium stats */}
                <section id="stats-section" className="px-4 sm:px-6 lg:px-8 mt-10 mb-20 max-w-7xl mx-auto w-full">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <StatsCard title="Total Matches" value="1095+" accent="cyan" />
                        <StatsCard title="Franchises" value="10" accent="purple" />
                        <StatsCard title="Players" value="290+" accent="indigo" />
                        <StatsCard title="Seasons" value="18" accent="amber" />
                    </div>
                </section>
                ...
                <section className="px-4 sm:px-6 lg:px-8 mb-20 max-w-7xl mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <Link to="/teams" className="group" id="teams-section">
