                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="feature-card bg-gray-800 p-8 rounded-2xl shadow-2xl transform hover:-translate-y-3 transition-all duration-500 ease-in-out border border-indigo-700 hover:border-yellow-400 cursor-pointer">
                                ...
                                <div className="mt-6 text-center">
                                    <Link to="/teams" className="text-yellow-300 hover:text-yellow-500 font-semibold text-lg">Learn More →</Link>
                                </div>
                            </div>
                            <div className="feature-card bg-gray-800 p-8 rounded-2xl shadow-2xl transform hover:-translate-y-3 transition-all duration-500 ease-in-out border border-indigo-700 hover:border-green-400 cursor-pointer">
                                ...
                                <div className="mt-6 text-center">
                                    <Link to="/players" className="text-green-300 hover:text-green-500 font-semibold text-lg">View Players →</Link>
                                </div>
                            </div>
                            <div className="feature-card bg-gray-800 p-8 rounded-2xl shadow-2xl transform hover:-translate-y-3 transition-all duration-500 ease-in-out border border-indigo-700 hover:border-red-400 cursor-pointer">
                                ...
                                <div className="mt-6 text-center">
                                    <Link to="/head-to-head" className="text-red-300 hover:text-red-500 font-semibold text-lg">Compare Now →</Link>
                                </div>
                            </div>
                        </div>
                        {/* NEW: Leaderboard Link for more discovery */}
                        <div className="mt-12 text-center">
                             <Link to="/leaderboard" className="inline-flex items-center px-8 py-3 border-2 border-indigo-400 text-lg font-bold rounded-full text-indigo-200 bg-transparent hover:bg-indigo-700 hover:border-indigo-700 transform hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
