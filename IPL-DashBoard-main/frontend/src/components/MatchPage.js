...
const MatchPage = () => {
    ...
    return (
        <div className="MatchPage p-6 bg-gray-800 rounded-lg shadow-xl text-white max-w-3xl mx-auto my-8">
            <h1 className="text-4xl font-extrabold text-center mb-6 text-indigo-400">Match Details</h1>
            <div className="text-left space-y-4 text-lg">
                ...
                <div className="border-t border-gray-700 pt-4 mt-4">
                    <p className="text-2xl font-bold mb-2">Winner: <span className="text-green-400">{winnerTeam}</span></p>
                    <p><span className="font-semibold">{winnerTeam}</span> won by {match.resultMargin} {match.result} against <span className="text-red-400">{loserTeam}</span>.</p>
                </div>
                {match.playerOfMatch && (
                    <div className="border-t border-gray-700 pt-4 mt-4">
            ...
            <div className="mt-8 text-center">
                <Link to={`/teams/${match.team1}`} className="inline-block bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 transition-colors duration-200">View {match.team1} Team Page</Link>
                <Link to={`/teams/${match.team2}`} className="inline-block bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 transition-colors duration-200 ml-4">View {match.team2} Team Page</Link>
            </div>
        </div>
    );
};
